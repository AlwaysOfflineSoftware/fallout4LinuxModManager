...
Begin DesktopWindow MainScreen
   ...
   Begin DesktopButton btn_Toggle
      ...
      Width           =   80
   End
   Begin DesktopButton btn_PlayFO4
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "Play Fallout 4"
      Default         =   False
      Enabled         =   False
      FontName        =   "System"
      FontSize        =   0.0
   ...
   Begin DesktopButton btn_Install
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   "WIP, will come with Fomod support"
      Top             =   96
      Transparent     =   False
      Underline       =   False
      Visible         =   True
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  Self.lsb_ModOrderList.ColumnAttributesAt(App.COL_NAME).WidthActual=(lsbWidth*0.55)
		  ...
		  If(App.launchCommand="None" Or App.launchCommand="") Then
		    Self.btn_PlayFO4.Enabled= False
		    Self.btn_PlayFO4.Tooltip="Please set launch command in settings"
		  Else
		    Self.btn_PlayFO4.Enabled= True
		    Self.btn_PlayFO4.Tooltip="Play Fallout 4!"+EndOfLine+App.launchCommand
		  End
	...
	#tag MenuHandler
		Function toolsF4SEManager() As Boolean Handles toolsF4SEManager.Action
		  f4seScreen.Show
		  Return True
...
#tag Events btn_Apply
	#tag Event
		Sub Pressed()
		  Fallout4ModHandler.ApplyPluginOrder
		  Fallout4ModHandler.ApplyUserDlContentOrder
		  Fallout4ModHandler.ApplyDLCOrder
	...
	#tag Event
		Sub Pressed()
		  ...
		  If(selectedZipMod<>Nil) Then
		    Var installed As Boolean= Fallout4ModHandler.InstallMod(selectedZipMod)
