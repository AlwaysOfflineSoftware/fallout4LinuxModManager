...
Begin DesktopWindow AboutScreen
   ...
   Begin DesktopLabel lbl_ProgramDesc
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "The Fallout 4 Linux Modder is the first Fallout 4 mod manager made for Linux. Too long has it been that Windows is the premiere modding platform for Fallout 4 (and many other games) and Always Offline Software is going to change that!"
      TextAlignment   =   2
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   32
