...
Begin DesktopWindow SettingsScreen
   ...
   Begin DesktopLabel lbl_PluginFile
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Fallout 4 Plugin File Folder:"
      TextAlignment   =   0
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   59
   ...
   Begin DesktopTextField txt_PluginFile
      ...
      HasBorder       =   True
      Height          =   27
      Hint            =   "/home/user/.../.../Local/Fallout 4/"
      Index           =   -2147483648
      Italic          =   False
      Left            =   198
      LockBottom      =   False
   ...
   Begin DesktopTextField txt_DataFolder
      ...
      HasBorder       =   True
      Height          =   27
      Hint            =   "/home/user/.../steamapps/common/Fallout 4/Data"
      Index           =   -2147483648
      Italic          =   False
      Left            =   174
      LockBottom      =   False
   ...
   Begin DesktopTextField txt_LaunchCommand
      ...
      HasBorder       =   True
      Height          =   27
      Hint            =   "steam steam://rungameid/377160"
      Index           =   -2147483648
      Italic          =   False
      Left            =   174
      LockBottom      =   False
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  Self.txt_DataFolder.Text= App.falloutData.NativePath
		  Self.txt_PluginFile.Text= App.BaseDir.NativePath
		  Self.txt_LaunchCommand.Text= App.launchCommand
		End Sub
	#tag EndEvent
		    ...
		    If(Utils.ValidatePath(Self.txt_DataFolder.Text)) Then
		      ...
		      If(Utils.ValidatePath(Self.txt_PluginFile.Text)) Then
		        ...
		        If(Self.txt_LaunchCommand.Text<>"") Then
		          App.launchCommand= SharedModTools.PrivilegeCommandCheck(Self.txt_LaunchCommand.Text)
		        Else
		        ...
		        If(App.launchCommand="None" Or App.launchCommand="") Then
		          MainScreen.btn_PlayFO4.Enabled= False
		          MainScreen.btn_PlayFO4.Tooltip="Please set launch command in settings"
		        Else
		          MainScreen.btn_PlayFO4.Enabled= True
		          MainScreen.btn_PlayFO4.Tooltip="Play Fallout 4!"+EndOfLine+App.launchCommand
		        End
		      Else
